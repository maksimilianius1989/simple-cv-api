...
export class TelegramUpdate {
  ...
  async start(@Ctx() ctx: Context) {
    ...
    Пиши прямо сюди повідомленням, <b>в довільній розмовній формі</b> як тобі зручно,
    ...
    щоб ми сформували твоє резюме і відправили тобі результат в твій особистий кабінет.`,
  ...
  async loginToDashboard(@Ctx() ctx: Context) {
    ...
    await ctx.replyWithPhoto(Input.fromLocalFile(imagePath), {
      caption: 'Натисни кнопку нижче, щоб увійти до Особистого кабінету:',
      reply_markup: Markup.inlineKeyboard([
        [
          Markup.button.url(
